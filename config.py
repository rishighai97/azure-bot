...
#    APP_PASSWORD = os.environ.get("MicrosoftAppPassword", "")
    PORT = 3978
    APP_ID = os.environ.get("MicrosoftAppId", "4bfb2bef-dee0-4962-bab0-1a3b73821442")
    ...
    CV_SUBSCRIPTION_KEY = os.environ.get("CVSubscriptionKey1", "d27103a850c04079bb365dd8cfedcf53")
    ...
    BING_KEY = os.environ.get("BING_KEY1", "ac85703fb7f846bc81acbd45f99c86d8")
